<div class="space-y-6">
    @php
        ...
        foreach ($data as $costs) {
            $totalMiscellaneous += $costs->sum('nominal');
        }
    @endphp

    <div class="bg-purple-50 p-4 rounded-lg">
        <h4 class="font-medium text-purple-800 mb-2">Ringkasan Biaya Lain-lain</h4>
        <p class="text-purple-700">Total Biaya Lain-lain: Rp {{ number_format($totalMiscellaneous, 0, ',', '.') }}</p>
    </div>
