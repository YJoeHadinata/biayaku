<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Tambah Variasi untuk Produk: ') . $product->nama }}
        </h2>
    </x-slot>
                    ...
                    <form method="POST" action="{{ route('products.variations.store', $product) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama" id="nama" value="{{ old('nama') }}"
                                placeholder="Contoh: 100g, Vanilla, Large"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="harga_tambahan" id="harga_tambahan"
                                value="{{ old('harga_tambahan', 0) }}" step="0.01" min="0"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="multiplier" id="multiplier" value="{{ old('multiplier', 1.0) }}"
                                step="0.01" min="0.1"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                required>
                            <p class="mt-1 text-sm text-gray-600">
