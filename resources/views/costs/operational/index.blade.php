                            ...
                            <tbody>
                                @forelse($costs as $cost)
                                    <tr class="border-t">
                                        ...
                                        <td class="px-4 py-2">
                                            <a href="{{ route('operational.edit', $cost) }}"
                                                class="text-blue-600 hover:text-blue-900 mr-2">
                                                <i class="bi bi-pencil"></i> Edit
                                            </a>
                                            <form method="POST" action="{{ route('operational.destroy', $cost) }}"
                                                class="inline"
                                                onsubmit="return confirm('Apakah Anda yakin ingin menghapus biaya operasional ini?')">
                                                @csrf
                                                @method('DELETE')
