                    ...
                    <form method="POST" action="{{ route('products.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="unit_output" id="unit_output"
                                ...
                                <option value="kg" {{ old('unit_output') == 'kg' ? 'selected' : '' }}>kg</option>
                                <option value="liter" {{ old('unit_output') == 'liter' ? 'selected' : '' }}>liter
                                </option>
                                <option value="pcs" {{ old('unit_output') == 'pcs' ? 'selected' : '' }}>pcs</option>
                                <option value="gram" {{ old('unit_output') == 'gram' ? 'selected' : '' }}>gram
                                </option>
                                <option value="ml" {{ old('unit_output') == 'ml' ? 'selected' : '' }}>ml</option>
                            </select>
                            @error('unit_output')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
